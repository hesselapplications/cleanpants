    ...
    nodes: [
      ...
      },
      {
        ...
        actions: [
          ...
          {
            text:
              "Go grab the can, we all have to do our share to keep this planet clean",
            goToNode: 31
          }
        ]
      },
      ...
      },
      {
        ...
        actions: [
          {
            text:
              "Dodge left by diving onto the freshly-mowed-and-likely-to-cause-grass-stains lawn",
            goToNode: 9
          },
          {
      ...
      },
      {
        ...
        actions: [
          ...
          {
            text:
              "Creep slowly. You can never be too careful with only one pair of clean pants",
            goToNode: 15
          }
        ]
      },
      {
        ...
        actions: [
          ...
          {
            text:
              "Screw it, I need to just get to this date with only one pants imperfection. Let's head to the car.",
            goToNode: 26
          }
        ]
      },
      ...
      },
      {
        ...
        actions: [
          {
            text:
              '"You can\'t win them all" you say to yourself and continue on with your day',
            goToNode: 19
          }
        ]
      },
      ...
      },
      {
        ...
        actions: [
          {
            text:
              "Wow! My hands feel fresh, time for my date. Let's go to the car",
            goToNode: 26
          }
        ]
      },
      ...
      },
      {
        ...
        actions: [
          ...
          {
            text:
              "Take your time, she will understand - the pants are the most important thing here right?",
            goToNode: 25
          }
        ]
      },
      ...
      },
      {
        ...
        actions: [
          ...
          {
            text:
              "... Leave the can... it's not worth it. You need to wash your hands and get going.",
            goToNode: 7
          }
        ]
      },
      {
        ...
        actions: [
          {
            text:
              ".... This really isn't worth it, I'm just going to leave it.",
            goToNode: 7
          },
          {
      ...
      },
      {
        ...
        actions: [
          {
            text:
              "Crank up window and keep driving and arrive at Beau Pantalon and park",
            goToNode: 39
          }
        ]
      },
      ...
      },
      {
        ...
        actions: [
          {
            text:
              "First I want to check if my pants are clean in the bathroom.",
            goToNode: 40
          },
          {
      ...
      },
      {
        ...
        actions: [
          {
            text:
              "Yup... those are pants.... and they are exactly in the state that they were meant to be based on my decisions",
            goToNode: 42
          }
        ]
      },
      ...
      },
      {
        ...
        actions: [
          {
            text:
              "Time go home... I never should have believed I could keep this pants clean. Game over",
            goToNode: 1
          }
        ]
      },
      ...
      },
      {
        ...
        actions: [
          {
            text:
              "Introduce yourself and compliment her appearence and sit down for your date.",
            goToNode: 50
          },
          {
            text:
              "Ignore her and check your seat for anything that could get your pants dirty.",
            goToNode: 51
          }
        ]
      },
      ...
      },
      {
        ...
        actions: [
          ...
          {
            text:
              "Tuck the napkin into your shirt collar and underneathe your plate - as to form a wall between your pants and anything from the table..",
            goToNode: 54
          }
        ]
      },
      ...
      },
      {
        ...
        actions: [
          {
            text:
              "Pat your self on the back for the stroke of genius that was your napkin protection",
            goToNode: 55
          }
        ]
      },
      {
        ...
        actions: [
          ...
          {
            text:
              "Let her smear the chocolate all over the side your pants as you kiss her.",
            goToNode: 57
          }
        ]
      },
