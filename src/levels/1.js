export default {
  level: {
    ...
    nodes: [
      ...
      {
        id: 3,
        text: "You decide to take two shots of vodka before you head out, but you realize your uber is waiting. You run out to catch your ride and you trip on the crub like a clutz.",
        image: "pants.png",
        timed: false,
        actions: [
          {
      ...
      {
        id: 5,
        text: "You pull up to to Pattay Nicepants house and realize the party has been going on for awhile. You hear lots of laughter from the back, but there is also a bunch of people on the front porch.",
        image: "pants.png",
        timed: false,
        actions: [
          {
      ...
      {
        id: 11,
        text: "You run into the house and bump into some eating wings in a hurry trying to clean off your pants. The wings land all over the floor and all over you.",
        image: "pants.png",
        timed: false,
        actions: [
          {
      ...
      {
        id: 15,
        text: "You yell at the guys and they turn around and push you into the dirt. Everyone arounds stands around and ridicules you for your dirt covered pants.",
        image: "pants.png",
        timed: false,
        actions: [
            {
      ...
      {
        id: 20,
        text: "As you leave the bathroom Patty comes up to you. 'That was amazing those guys were jerks and did you see there pants?'",
        image: "pants.png",
        timed: false,
        actions: [
            {
